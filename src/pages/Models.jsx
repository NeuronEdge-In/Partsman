...
import { models, BRANDS } from '../data/catalog.js';
...
export default function Models() {
  ...
  return (
    <>
      <PageHead eyebrow="Shop by vehicle" title="All vehicle models" lead="Choose your truck to see every bumper, door, fender, pillar and panel we stock for it." crumbs={[{ label: 'Vehicle models' }]} image="/images/models/tata-signa-truck-body-parts.png" />
